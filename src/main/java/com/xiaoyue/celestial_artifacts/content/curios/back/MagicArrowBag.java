...
public class MagicArrowBag extends XICurioBase {
    ...
    public Multimap<Attribute, AttributeModifier> setModifiers(String identifier, UUID uuid, ItemStack stack, Multimap<Attribute, AttributeModifier> Modifiers) {
        Modifiers.put(CAttributes.ARROW_DAMAGE.get(), new AttributeModifier(uuid, "extra arrow damage", 0.1, AttributeModifier.Operation.MULTIPLY_BASE));
        Modifiers.put(CAttributes.ARROW_KNOCK.get(), new AttributeModifier(uuid, "extra arrow knock", 0.08, AttributeModifier.Operation.MULTIPLY_BASE));
        return Modifiers;
    }
